...
// Union of blocks across about-us (contributor grids) and magazine landing
// (featured columns + article teaser cards). Missing blocks on a given page
// are skipped gracefully by findBlocksOnPage.
const PAGE_TEMPLATE = {
  name: 'content-landing',
  description: 'Content landing layout with hero header and a grid or list of content teasers',
  urls: [
